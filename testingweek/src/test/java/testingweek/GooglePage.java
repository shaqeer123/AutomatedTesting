...
public class GooglePage {
	...
	@FindBy(css = "body > div > center > table > tbody > tr:nth-child(2) > td > div > center > table > tbody >"
			+ " tr > td:nth-child(2) > p > small > a:nth-child(6)")
	...
	public void clickUserTab(String userName, String password) {
		addUserTab.click();
		userTabUserName.sendKeys(userName);
		userTabPassword.sendKeys(password);
		userTabSave.click();
	}
	...
	public void clickLoginTab(String userName, String password) {
		loginTab.click();
		userTabUserName.sendKeys(userName);
		userTabPassword.sendKeys(password);
		userTabSave.click();
